...
class CastleDoomMap internal constructor(stage: Stage, mapPath:String = "maps/castleDoom.tmx"): TileMapActor(mapPath,stage) {
    private val TAG = CastleDoomMap::class.java.simpleName
